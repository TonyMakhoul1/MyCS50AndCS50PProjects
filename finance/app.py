...
def register():
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return apology("This name already exist")
...
def sell():
    ...
    if request.method == "GET":
        ...
        db.execute("INSERT INTO action(user_ID, symbol, shares, price, date) VALUES(?,?,?,?,?)", user_id, stock["symbol"], (-1)*shares, stock["price"],date)
